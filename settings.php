...
/**
 * notebookdec module admin settings and defaults
 *
 * @package    mod
...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configmultiselect('notebookdec/displayoptions',
        'Display Options', '',
        $defaultdisplayoptions, $displayoptions));

    $settings->add(new admin_setting_configselect_with_advanced('notebookdec/display',
        'Default Display', 'Sets the default display type',
        array('value'=>RESOURCELIB_DISPLAY_AUTO, 'adv'=>false), $displayoptions));
    $settings->add(new admin_setting_configtext_with_advanced('notebookdec/popupwidth',
        'Pop-Up Width', 'Default Pop-Up Width in Pixels',
        array('value'=>620, 'adv'=>true), PARAM_INT, 7));
    $settings->add(new admin_setting_configtext_with_advanced('notebookdec/popupheight',
